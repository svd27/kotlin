...
public class IntrinsicMethods {
    ...
    public void init() {
        ...
        intrinsicsMap.registerIntrinsic(BUILT_INS_PACKAGE_FQ_NAME, Name.identifier("name"), 0, new EnumName());
        intrinsicsMap.registerIntrinsic(BUILT_INS_PACKAGE_FQ_NAME, Name.identifier("ordinal"), 0, new EnumOrdinal());
