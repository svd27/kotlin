...
public class DeclarationsChecker {
    ...
    private void checkEnumEntry(@NotNull JetEnumEntry enumEntry, @NotNull ClassDescriptor enumEntryClassObject) {
        DeclarationDescriptor declaration = enumEntryClassObject.getContainingDeclaration().getContainingDeclaration();
        assert declaration instanceof ClassDescriptor : "Enum entry should be declared in enum: " + declaration;
