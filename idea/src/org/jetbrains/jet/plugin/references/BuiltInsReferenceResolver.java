...
public class BuiltInsReferenceResolver extends AbstractProjectComponent {
    ...
    private Set<JetFile> builtInsSources = Sets.newHashSet();
    private MutablePackageFragmentDescriptor builtinsPackageFragment;
    ...
    private void initialize() {
        ...
        builtInsSources = Sets.newHashSet(getJetBuiltInsFiles());
