...
public class SpecialNames {
    public static final Name ANONYMOUS_OBJECT = Name.special("<no name provided>");
    ...
    public static boolean isClassObjectName(@NotNull Name className) {
        return className.isSpecial() && className.asString().startsWith(CLASS_OBJECT_FOR);
    }
}
