...
public final class JavaFunctionResolver {
    ...
    @Nullable
    private static ClassDescriptorFromJvmBytecode findClassInPackage(@NotNull JavaPackageFragmentDescriptor fragment, @NotNull Name name) {
        // First, try to find in fragment directly
        ClassDescriptorFromJvmBytecode found = findClassInScope(fragment.getMemberScope(), name);
        if (found != null) {
            return found;
        }
    ...
    @Nullable
    private static JavaPackageFragmentDescriptor getParentPackage(JavaPackageFragmentDescriptor fragment) {
    ...
    @Nullable
    public static ClassDescriptorFromJvmBytecode getClassForCorrespondingJavaPackage(@NotNull JavaPackageFragmentDescriptor fragment) {
        JavaPackageFragmentDescriptor parentPackage = getParentPackage(fragment);
        if (parentPackage == null) {
            return null;
        }
    ...
    public static SamConstructorDescriptor resolveSamConstructor(@NotNull JavaPackageFragmentDescriptor owner, @NotNull NamedMembers namedMembers) {
        if (namedMembers.getSamInterface() != null) {
            ClassDescriptorFromJvmBytecode klass = findClassInPackage(owner, namedMembers.getName());
            if (klass != null) {
